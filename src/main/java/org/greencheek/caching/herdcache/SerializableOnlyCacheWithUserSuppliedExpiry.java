 ...
 * it is wrapped in a {@link org.greencheek.caching.herdcache.memcached.CachedItem}
 *
...
public interface SerializableOnlyCacheWithUserSuppliedExpiry<V extends Serializable> extends AwaitOnFuture<V> {
    ...
    *
     ...
     * value can always be stored in the cache.
     *
     * When an item is retrieved from the cache the {@link org.greencheek.caching.herdcache.memcached.CachedItem} creation
     * date is checked to see if it's time to live, according to the passed Duration, has expired.  If the item is
     * not a {@link org.greencheek.caching.herdcache.memcached.CachedItem} then it is valid.
     *
     * @param key The key to look in the cache for, or store the value from theBackEndCall
     * @param theBackEndCall The {@link java.util.function.Supplier} that generates the
     *                       value that should be cached against the key
     * @param cachedItemAgeInMillis  The max age of a {@link org.greencheek.caching.herdcache.memcached.CachedItem}.
     * @return
     */
     ...
     * @param theBackEndCall The {@link java.util.function.Supplier} that generates the
     *                       value that should be cached against the key
     * @param cachedItemAgeInMillis The max age of a {@link org.greencheek.caching.herdcache.memcached.CachedItem} in millis
     * @return
     */
     ...
     * If the item is not a {@link org.greencheek.caching.herdcache.memcached.CachedItem} then it is valid.
     *
     *
     *
     * @param key The key to look in the cache for, or store the value from theBackEndCall
     ...
     *
     * When an item is retrieved from the cache the {@link org.greencheek.caching.herdcache.memcached.CachedItem}
     * If the item is not a {@link org.greencheek.caching.herdcache.memcached.CachedItem} then it is valid to be used.
     * If it is a CachedItem, then if  is passed to the instance of the predeciate: {@link org.greencheek.caching.herdcache.memcached.predicates.CachedItemPredicate}
     *
     *
     *
     * @param key The key to look in the cache for, or store the value from theBackEndCall
     ...
     * @param theBackEndCall The {@link java.util.function.Supplier} that generates the
     *                       value that should be cached against the key
     * @param getInspectionTTLInMillis The max age of a {@link org.greencheek.caching.herdcache.memcached.CachedItem} as a {@link java.time.Duration}
     *
     * @param isCachedValueUsable A {@link org.greencheek.caching.herdcache.IsCachedValueUsable} that determines if the value
     *                          retrieve from the cache can be used, or if theBackEndCall should be executed for a value
     * @param isSupplierValueCachable This predicate is passed the generated item, and it determines if the item that has been
     ...
     * @param theBackEndCall The {@link java.util.function.Supplier} that generates the
     *                       value that should be cached against the key
     * @param getInspectionTTLInMillis The max age of a {@link org.greencheek.caching.herdcache.memcached.CachedItem} in millis
     * @param isCachedValueUsable A {@link java.util.function.Predicate} that determines if the value
     *                            retrieve from the cache can be used, or if theBackEndCall should be executed for a value
     * @param isSupplierValueCachable This predicate is passed the generated item, and determines if it can be cached or
     *                               not
     ...
     * @param theBackEndCall The {@link java.util.function.Supplier} that generates the
     *                       value that should be cached against the key
     * @param getInspectionTTLInMillis The max age of a {@link org.greencheek.caching.herdcache.memcached.CachedItem} as a long in millis
     * @param isCachedValueUsable A {@link java.util.function.Predicate} that determines if the value
     *                            retrieve from the cache can be used, or if theBackEndCall should be executed for a value
     * @param isSupplierValueCachable This predicate is passed the generated item, and determines if it can be cached or
     *                               not
