 ...
 */
public class MemcachedCache<V> implements CacheWithExpiry<V>,RequiresShutdown {
    ...
    public MemcachedCache(MemcachedCacheConfig config) {
        this.config = config;
    ...
    private void getFromStaleDistributedCache(String key,
        ...
        Object item = getFromDistributedCache(key,this.staleCacheMemachedGetTimeoutInMillis,MemcachedCache.CACHE_TYPE_STALE_CACHE);
    ...
    private ListenableFuture<V> cacheWriteFunction(Supplier<V> computation,
                                                   SettableFuture<V> promise,
                                                   String key, String staleCacheKey,
                                                   Duration itemExpiry,
